...
def craw_stock_price(**kwargs):
    ...
    stock_price_df.to_csv("/opt/airflow/dags/stock_price.csv", index=None)
    return True
...
def train_model():
    ...
    dataset_train = pd.read_csv('/opt/airflow/dags/stock_price.csv')
    ...
    regressor.save("/opt/airflow/dags/stockmodel.h5")
    return True
...
def email():
    ...
    out_csv_file_path = '/opt/airflow/dags/stock_price.csv'
    import base64
    message = Mail(
        from_email='vinh07052005@gmail.com',
        to_emails='vinhdl.l2023@gmail.com',
